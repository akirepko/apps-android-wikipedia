...
class SearchWidget:KWIdget<SearchWidget> {
    ...
    val searchIcon by lazy {KImageView(parent){
        withDrawable(R.drawable.ic_search_splash)
    }  }



    val searchText by lazy { KTextView(parent){
        withText(R.string.search_hint)
    }}

    val voiceIcon by lazy { KImageView(parent){
